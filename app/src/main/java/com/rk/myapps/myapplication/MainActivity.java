...
public class MainActivity extends AppCompatActivity {
    ...
    @OnClick(R.id.showImagesExample)
    public void showImage(View view) {
        //Intent intent = new Intent(getApplicationContext(), PicassoImageView.class);
        //startActivity(intent);
    }

    @OnClick(R.id.showImagesGridExample)
    public void showImagesGrid(View view) {
